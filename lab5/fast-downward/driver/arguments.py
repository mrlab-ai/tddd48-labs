...
def _set_components_and_inputs(parser, args):
    ...
    if first == "translate":
        ...
        elif args.test_projections:
            args.search_input = None
            args.search_options = ["--test-projections"]
        elif num_files == 1:
...
def parse_args():
    ...
    help_options.add_argument(
        "--test-projections", action="store_true",
        help="run test on the implementation of projections and exit")
