(define (problem castle-8-5-17-cards)
(:domain beleaguered-castle)
; Pile 0: heart7 heart8 spade4 heart5 diamond8 club5
; Pile 1: diamond5 heart3 diamond3 club4 diamond7 club2
; Pile 2: spade5 club7 spade7 spade6 club3 diamond2
; Pile 3: spade3 heart6 spade8 club6 heart2
; Pile 4: heart4 club8 diamond4 diamond6 spade2
(:objects
    pile0
    pile1
    pile2
