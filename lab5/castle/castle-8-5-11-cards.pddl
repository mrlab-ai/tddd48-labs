(define (problem castle-8-5-11-cards)
(:domain beleaguered-castle)
; Pile 0: spade2 heart4 spade3 club2 club3 club5
; Pile 1: heart5 diamond2 diamond6 diamond4 heart8 diamond3
; Pile 2: diamond8 club6 heart2 spade4 diamond7 spade7
; Pile 3: diamond5 heart7 heart3 club7 club4
; Pile 4: spade5 heart6 spade8 club8 spade6
(:objects
    pile0
    pile1
    pile2
