(define (problem castle-8-5-5-cards)
(:domain beleaguered-castle)
; Pile 0: diamond7 diamond2 heart7 club6 spade6 club7
; Pile 1: heart6 club5 heart8 spade3 spade5 diamond8
; Pile 2: heart4 club3 spade8 diamond3 heart5 diamond5
; Pile 3: spade2 heart3 diamond4 spade7 diamond6
; Pile 4: spade4 heart2 club2 club8 club4
(:objects
    pile0
    pile1
    pile2
