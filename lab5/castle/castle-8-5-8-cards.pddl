(define (problem castle-8-5-8-cards)
(:domain beleaguered-castle)
; Pile 0: spade5 spade2 club3 club8 spade4 heart5
; Pile 1: spade8 spade6 diamond2 diamond4 diamond8 club6
; Pile 2: club4 heart2 diamond3 heart3 diamond7 heart8
; Pile 3: club7 club5 diamond6 spade3 spade7
; Pile 4: heart6 club2 heart7 heart4 diamond5
(:objects
    pile0
    pile1
    pile2
