(define (problem castle-8-5-2-cards)
(:domain beleaguered-castle)
; Pile 0: diamond3 heart5 spade8 spade4 club8 heart3
; Pile 1: spade3 spade2 heart2 club3 heart6 club6
; Pile 2: club2 diamond6 diamond7 diamond5 heart7 club7
; Pile 3: club4 club5 spade5 spade6 spade7
; Pile 4: heart8 diamond2 diamond4 diamond8 heart4
(:objects
    pile0
    pile1
    pile2
