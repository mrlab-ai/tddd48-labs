(define (problem castle-8-5-16-cards)
(:domain beleaguered-castle)
; Pile 0: diamond2 diamond4 diamond6 spade2 heart3 club8
; Pile 1: club6 diamond8 diamond7 diamond5 spade3 spade7
; Pile 2: club4 heart5 club7 club3 heart6 spade5
; Pile 3: club5 heart4 heart8 club2 heart2
; Pile 4: spade8 heart7 diamond3 spade4 spade6
(:objects
    pile0
    pile1
    pile2
...
(:init
    (on diamond2 pile0)
    (on diamond4 diamond2)
    (on diamond6 diamond4)
    (on spade2 diamond6)
    (on heart3 spade2)
    (on club8 heart3)
    (on club6 pile1)
    (on diamond8 club6)
    (on diamond7 diamond8)
