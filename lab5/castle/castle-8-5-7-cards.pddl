(define (problem castle-8-5-7-cards)
(:domain beleaguered-castle)
; Pile 0: club7 diamond2 diamond6 diamond3 spade8 diamond4
; Pile 1: club8 diamond7 spade6 heart5 heart7 heart6
; Pile 2: diamond8 spade2 heart4 club6 club4 spade4
; Pile 3: heart8 diamond5 club2 club3 heart2
; Pile 4: spade5 club5 spade3 spade7 heart3
(:objects
    pile0
    pile1
    pile2
