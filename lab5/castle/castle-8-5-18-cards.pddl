(define (problem castle-8-5-18-cards)
(:domain beleaguered-castle)
; Pile 0: diamond8 diamond3 heart5 heart2 heart8 spade3
; Pile 1: club6 diamond6 heart3 diamond4 spade2 diamond5
; Pile 2: diamond2 heart4 spade8 club7 club3 heart7
; Pile 3: club2 diamond7 spade7 club5 club8
; Pile 4: spade4 spade5 club4 spade6 heart6
(:objects
    pile0
    pile1
    pile2
