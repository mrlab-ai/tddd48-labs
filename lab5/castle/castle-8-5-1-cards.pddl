(define (problem castle-8-5-1-cards)
(:domain beleaguered-castle)
; Pile 0: club4 spade8 heart6 diamond8 club6 diamond7
; Pile 1: heart7 club8 spade3 club2 diamond5 club3
; Pile 2: club7 heart4 spade4 club5 diamond6 heart5
; Pile 3: spade7 spade2 diamond3 heart2 heart3
; Pile 4: diamond4 diamond2 spade5 spade6 heart8
(:objects
    pile0
    pile1
    pile2
