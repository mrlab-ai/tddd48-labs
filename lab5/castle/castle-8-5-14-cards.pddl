(define (problem castle-8-5-14-cards)
(:domain beleaguered-castle)
; Pile 0: club8 spade4 spade5 club3 spade6 diamond4
; Pile 1: heart2 diamond5 club2 diamond3 diamond7 diamond6
; Pile 2: spade3 diamond2 heart6 spade7 heart5 heart4
; Pile 3: heart3 club7 spade2 diamond8 club5
; Pile 4: spade8 club6 heart7 heart8 club4
(:objects
    pile0
    pile1
    pile2
