(define (problem castle-8-5-3-cards)
(:domain beleaguered-castle)
; Pile 0: spade6 heart5 club4 spade7 heart4 spade4
; Pile 1: diamond6 club2 spade5 club8 diamond7 diamond2
; Pile 2: club6 club7 club3 spade3 diamond4 heart8
; Pile 3: spade8 spade2 diamond8 heart6 heart7
; Pile 4: diamond5 heart2 heart3 club5 diamond3
(:objects
    pile0
    pile1
    pile2
