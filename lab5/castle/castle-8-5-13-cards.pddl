(define (problem castle-8-5-13-cards)
(:domain beleaguered-castle)
; Pile 0: club6 spade8 club7 spade3 spade5 diamond5
; Pile 1: diamond3 club3 diamond7 spade7 heart3 diamond6
; Pile 2: diamond4 heart2 club8 spade6 heart8 spade2
; Pile 3: diamond8 club5 spade4 heart4 diamond2
; Pile 4: club4 heart5 heart7 heart6 club2
(:objects
    pile0
    pile1
    pile2
