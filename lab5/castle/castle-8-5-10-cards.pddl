(define (problem castle-8-5-10-cards)
(:domain beleaguered-castle)
; Pile 0: spade8 heart3 heart4 spade4 club4 club8
; Pile 1: club2 spade3 club5 club7 club3 spade6
; Pile 2: diamond8 diamond5 spade2 spade7 heart2 diamond3
; Pile 3: club6 diamond4 heart6 heart8 spade5
; Pile 4: heart5 diamond2 diamond6 diamond7 heart7
(:objects
    pile0
    pile1
    pile2
...
(:init
    ...
    (on heart5 pile4)
    (on diamond2 heart5)
    (on diamond6 diamond2)
    (on diamond7 diamond6)
    (on heart7 diamond7)
    (clear club8)
    (clear spade6)
    (clear diamond3)
