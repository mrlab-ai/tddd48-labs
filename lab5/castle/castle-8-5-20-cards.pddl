(define (problem castle-8-5-20-cards)
(:domain beleaguered-castle)
; Pile 0: spade7 diamond5 diamond3 heart2 club2 diamond7
; Pile 1: club4 club5 spade3 spade5 spade4 diamond6
; Pile 2: diamond8 heart4 heart7 spade8 heart6 club6
; Pile 3: heart3 diamond4 spade2 heart5 spade6
; Pile 4: club7 club8 diamond2 heart8 club3
(:objects
    pile0
    pile1
    pile2
